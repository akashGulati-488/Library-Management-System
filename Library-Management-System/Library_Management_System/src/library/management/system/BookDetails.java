    ...
    public BookDetails() {
        ...
        table.addMouseListener(new MouseAdapter() {
            	...
            	public void mouseClicked(MouseEvent arg0) {
            		...
            		searchText.setText(table.getModel().getValueAt(row, 0).toString());
            	}
        });
        ...
        l2.setFont(new Font("Cosmic Sans", Font.BOLD, 18));
        ...
        mainPanel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Book Details",
    ...
    public void actionPerformed(ActionEvent ae){
    	...
    	try{
            ...
            if(ae.getSource() == delete){
                String sql = "delete from book where bookName = '" + searchText.getText() + "'";
                PreparedStatement st = con.conn.prepareStatement(sql);
